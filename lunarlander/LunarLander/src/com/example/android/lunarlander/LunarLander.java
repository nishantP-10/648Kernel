...
public class LunarLander extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bLeft = (Button) findViewById(R.id.leftButton);
        bRight = (Button) findViewById(R.id.rightButton);
        bFire = (Button) findViewById(R.id.fireButton);
        ...
        bLeft.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					mLunarView.onKeyUp(KeyEvent.KEYCODE_DPAD_LEFT, null);
				}
				return false;
			}
		});
        ...
        bRight.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					mLunarView.onKeyUp(KeyEvent.KEYCODE_DPAD_RIGHT, null);
				}
				return false;
			}
		});
		...
		bFire.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN) {
					mLunarView.onKeyDown(KeyEvent.KEYCODE_DPAD_CENTER, null);
				} else if (event.getAction() == MotionEvent.ACTION_UP) {
					mLunarView.onKeyUp(KeyEvent.KEYCODE_DPAD_CENTER, null);
				}
				return false;
			}
		});
